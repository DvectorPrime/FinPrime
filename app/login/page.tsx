      ...
      <main className="block h-fit">
        <div className="mx-auto -mt-7.5 w-[90%] max-w-112.5-auto pt-4 pb-8 bg-white dark:bg-slate-800 rounded-xl shadow-xs">
          ...
          {/* <fieldset className="border-t border-neutral-300 dark:border-slate-600 w-[85%] mx-auto mt-3 pt-4">
            ...
            <button onClick={handleGoogleSignIn} className="flex items-center justify-center gap-3 h-11 w-full mt-4 bg-white dark:bg-slate-700 rounded-md border border-neutral-300 dark:border-slate-600 font-sans text-sm font-medium text-neutral-900 dark:text-neutral-100 transition-colors hover:cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-600">
